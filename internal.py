...
class GestureController:
    ...
    def __init__(self, root):
        ...
        self.root.geometry("400x477")
        self.style.set_theme("equilux")
        self.canvas = tk.Canvas(root,bg="#26242f")
        self.canvas.pack()
        self.start_control_button = tk.Button(root, text="Start Control",width=10, bd='2', command=self.start_control)
        self.start_control_button.place(x=90, y=400)
        self.stop_control_button = tk.Button(root, text="Stop Control",width=10, bd='2', command=self.stop_control)
        self.stop_control_button.place(x=210, y=400)
    ...
    def start_control(self):
        ...
        GestureController.gc_mode = 1
        # self.start_control_button["state"] = "disabled"  # Disable the button after starting
        ...
        with mp_hands.Hands(max_num_hands=2, min_detection_confidence=0.5, min_tracking_confidence=0.5) as hands:
            while GestureController.cap.isOpened() and GestureController.gc_mode:
                ...
                images = image  # Update the global variable
                ...
                self.update_video_stream(image)

                if cv2.waitKey(5) & 0xFF == 13:
                    break
    def stop_control(self):
        # self.start_control_button["state"] = "enabled"
